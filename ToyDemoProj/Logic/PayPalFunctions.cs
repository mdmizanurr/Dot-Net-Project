...
using System.Linq;
    ...
    public string APIUsername = "<mizan.jucse-facilitator_api1.outlook.com>";
    private string APIPassword = "<L59LQZWYUJTLY4FV>";
    private string APISignature = "<AV-1-EaddlMnGahY0QuiPJQj6r5cAbbsvWlAGbZ-ITJTs7RmSFZ0XPBA>";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44374/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44374/Checkout/CheckoutCancel.aspx";
        ...
        using (ToyDemoProj.Logic.ShoppingCartActions myCartOrders = new ToyDemoProj.Logic.
            ShoppingCartActions())
        { 
    ...
    public bool GetCheckoutDetails(string token, ref string PayerID, ref NVPCodec decoder, ref string
retMsg)
    {
        if (bSandbox)
        {
